...
data Context (vars :: Nat) (globals :: Nat) where
    Empty  :: Context Z Z
    Global :: Context vars globals -> Type globals -> Context (S vars) (S globals)
    Local  :: Context vars globals -> Type globals -> Value globals -> Context (S vars) globals
...
rlookup :: Fin vars -> Context vars globals -> Type globals
...
llookup :: Fin vars -> Context vars globals -> Type globals
